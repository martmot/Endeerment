  ...
  return (
    <div className="relative grid min-h-screen grid-cols-1 overflow-hidden bg-forest-gradient md:grid-cols-2">
      ...
      <div className="relative hidden items-center justify-center md:flex">
        <div
          className="absolute inset-8 rounded-2xl border border-slate-300/40"
          style={{
            background:
              'linear-gradient(180deg, rgba(22,49,38,0.96) 0%, rgba(8,22,16,0.98) 100%)',
          }}
        />
        <motion.div
        ...
        >
          ...
          <p className="mt-6 text-center font-display text-xl tracking-tight text-ink-soft">
            Your deer is already here. Waiting, patient as a clearing at dusk.
          </p>
        </motion.div>
      </div>
    </div>
